...
A = (11.009502, -74.862256)
B = (11.006436, -74.855260)
...
try:
    ...
    if option == 'y':
        ...
        C = (10.996870, -74.866317)
        
        D = [(10.998035, -74.865692), (10.998955, -74.864693), (10.999936, -74.863693), (11.001469, -74.862819), (11.002880, -74.862381), (11.003983, -74.862007), (11.005149, -74.861007), (11.006068, -74.860382), (11.007111, -74.858824), (11.008162, -74.857966), (11.011827, -74.855992)]
        index = 0
        ...
        while True:
            ...
            line2 = LineString([C, D[index]])

            print("Line A({}) and B ({}) and Line C ({}) and D ({}) and current index {}".format(A, B, C, D[index], index))
